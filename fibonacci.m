...
hold on
yline(1.61803398874,'-b','$\phi$','Linewidth',1.2,'interpreter','latex')
xlim([0 fn(length(fn))])
title("Ratio of Successive Terms of Fibonacci Sequence Converge to $\phi$",'interpreter','latex')
legend('$f(n)/f(n-1)$','$\phi$','interpreter','latex')
xlabel("$f(n):$ nth Fibonacci Sequence",'interpreter','latex') 
ylabel("$f(n)/f(n-1)$",'interpreter','latex')
